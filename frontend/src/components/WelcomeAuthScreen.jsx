...
import { Sparkles, Mail, Lock, User, ArrowRight, ShieldCheck, CheckCircle2, ChevronDown, ChevronUp, Loader2 } from 'lucide-react';
        ...
        <div className="bg-slate-900 border border-amber-500/40 rounded-3xl w-full max-w-md overflow-hidden shadow-2xl p-5 sm:p-7 space-y-5 text-center my-auto">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full py-3.5 px-4 bg-white hover:bg-slate-100 text-slate-900 font-black text-sm rounded-2xl shadow-xl flex items-center justify-center gap-3 cursor-pointer transition-all active:scale-98 disabled:opacity-75"
            >
              {googleLoading ? (
                <>
