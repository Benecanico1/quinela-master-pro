        ...
        if len(num) == 2:
            if target_pos == "cabeza":
                if num == head_2:
                    ...
                    details = f"Salió {head_2} a la cabeza"
                ...
                if hit_count > 0:
                    ...
                    details = f"¡Apareció {hit_count} vez/veces a los {limit_pos}!"
                else:
                    details = f"No apareció en los primeros {limit_pos}"
...
fs.writeFileSync('expert_engine.py', code, 'utf8');
console.log('expert_engine.py cleanly written');
